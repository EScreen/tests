...
public class NewTemplate_MainUser {
    ...
    public void cropImg(){
        ...
        Selenide.actions().dragAndDropBy($("span.cropper-point.point-nw"), 50, 0).build().perform();
        $(flexibleToolPage.acceptCropping).click();
        $(flexibleToolPage.saveCropping).click();

        int widthAfter = $("div.vdr.draggable.resizable > img").getSize().height;
